...
- `.json` files containing comments or trailing commas are formatted through the JSONC formatter instead of being skipped, so their indentation is normalized like prettier does (closes #584).
